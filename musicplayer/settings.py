...
ALLOWED_HOSTS = ['sumedhplayer.vercel.app', '.vercel.app', '127.0.0.1', 'localhost']
...
if 'VERCEL' in os.environ:
    ...
    if not os.path.exists(db_path):
        shutil.copy2(os.path.join(BASE_DIR, 'db.sqlite3'), db_path)
...
# Point media to a subfolder of static for easy serving on Vercel
